#region Constructor
	...
	self.initialize("Porta Bandeira", 
	...
	limitStrOrMag = irandom_range(10,12);
	limitSkill = irandom_range(10,12);
	limitSpd = irandom_range(13,15);
	limitLuck = irandom_range(12,14);
	limitDef = irandom_range(10,12);
	limitRes = irandom_range(12,14);
	limitCon = irandom_range(12,14);
	limitAid = irandom_range(17,19);
	
	// Atributos de equipamento
	// array de weapon possui nome da arma, tipo, alcance e dano bonus
	self.setWeapon(["Lança de cobre", "Lança", 1, 0]);

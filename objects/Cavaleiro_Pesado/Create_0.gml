#region Constructor
	...
	self.initialize("Cavaleiro Pesado", 
	irandom_range(4,5), // HP
	irandom_range(5,6),
	irandom_range(3,5),
	irandom_range(2,4),
	irandom_range(2,4),
	...
	limitStrOrMag = irandom_range(18,20);
	limitSkill = irandom_range(11,14);
	limitSpd = irandom_range(9,12);
	limitLuck = irandom_range(9,12);
	limitDef = irandom_range(18,20);
	limitRes = irandom_range(12,16);
	limitCon = irandom_range(14,16);
	limitAid = irandom_range(9,12);
	
	// Atributos de equipamento
	// array de weapon possui nome da arma, tipo, alcance e dano bonus
	self.setWeapon(["Espada de cobre", "Espada", 1, 0]);

#region Constructor
	...
	limitSkill = irandom_range(15,17);
	limitSpd = irandom_range(13,14);
	limitLuck = irandom_range(15,16);
	limitDef = irandom_range(10,11);

#region Constructor
	...
	self.initialize("Brigador", 
	irandom_range(5,7), // HP
	irandom_range(5,7),
	irandom_range(3,4),
	irandom_range(2,4),
	irandom_range(3,4),
	...
	limitSpd = irandom_range(10,12);
	limitLuck = irandom_range(11,14);
	limitDef = irandom_range(15,16);
	limitRes = irandom_range(14,16);
	limitCon = irandom_range(18,20);
	limitAid = irandom_range(11,14);
	
	// Atributos de equipamento
	// array de weapon possui nome da arma, tipo, alcance e dano bonus
	self.setWeapon(["Mãos", "Desarmado", 1, 0]);
